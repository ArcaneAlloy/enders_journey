...
execute as @s[tag=zerog_arrow] at @s if predicate ej_weapon:in_ground run function ej_weapon:powers/crossbows/zerog_arrow
...
execute as @s[tag=plague_arrow] at @s if predicate ej_weapon:in_ground run function ej_weapon:powers/bows/plague_arrow
...
execute as @s[tag=spider_arrow] at @s if predicate ej_weapon:in_ground run function ej_weapon:powers/crossbows/spider_arrow


execute as @s[predicate=ej_weapon:in_ground] run tag @s remove customarrow