execute as @p[nbt={Inventory:[{id:"minecraft:tipped_arrow",tag:{CustomPotionEffects:[{Id:20b}]}}]}] run give @s minecraft:arrow 1
...
execute as @p[nbt={Inventory:[{id:"minecraft:tipped_arrow",tag:{CustomPotionEffects:[{Id:25b}]}}]}] run give @s minecraft:arrow 1
...
execute as @p[nbt={Inventory:[{id:"minecraft:tipped_arrow",tag:{CustomPotionEffects:[{Id:49b}]}}]}] run give @s minecraft:arrow 1
